...
import { L as Link, H as Head, E as ErrorBoundary2 } from "../hattip.js";
...
function MainLayout({ children }) {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(Head, { title: "Real estates", children: [
      /* @__PURE__ */ jsx("html", { lang: "en" }),
      /* @__PURE__ */ jsx("link", { rel: "icon", type: "image/x-icon", href: "/icon.svg" })
    ] }),
    /* @__PURE__ */ jsxs(
      ErrorBoundary2,
      {
