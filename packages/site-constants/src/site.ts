export const siteConfig = {
  ...
  location: "Nairobi",
  contactHeading: "Let's build your next system.",
  ...
  contactBlurb:
    "Open to projects, collaborations, and useful conversations about TypeScript, product architecture, and web systems in a freelance/fixed/fulltime term capacity",
  navItems: [
