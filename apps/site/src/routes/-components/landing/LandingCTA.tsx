...
export function LandingCTA() {
  return (
    <LandingSection id="contact" tone="base" className="text-base-content">
            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-base-content/70">
                  Open to freelance projects, collaborations, and useful conversations about
                  TypeScript, product architecture, and web systems.
                </p>

                <a
                  href={AppConfig.links.emailTo}
                  className="mt-8 inline-flex items-center gap-2 text-sm text-base-content/70 transition-colors hover:text-base-content"
                >
                  <Mail className="size-4" />
                  Or email me directly at {AppConfig.links.email}
                </a>
              </div>
