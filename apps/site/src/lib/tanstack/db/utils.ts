...
type WhereExpression = Parameters<typeof parseWhereExpression>[0];
...
export function parseWhereWithHandlers<T extends WhereClause>(whereExression?: WhereExpression) {
